...
public class quiz14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quiz14);
        total_count+=1;

        btn1 =(ImageButton)findViewById(R.id.answer14_1);
        btn2 =(ImageButton)findViewById(R.id.answer14_2);
        btn3 =(ImageButton)findViewById(R.id.answer14_3);
        btn4 =(ImageButton)findViewById(R.id.answer14_4);

        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                type[4]++;
                Toast.makeText(quiz14.this, "땡 틀렸습니다...", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(getApplicationContext(),answer14.class);
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(quiz14.this, "정답입니다~!", Toast.LENGTH_SHORT).show();
                correct_count+=1;
                leveltest_correct+=1;
                finish();
                return;
