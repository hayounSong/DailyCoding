...
public class quiz4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1 =(ImageButton)findViewById(R.id.answer4_1);
        btn2 =(ImageButton)findViewById(R.id.answer4_2);
        btn3 =(ImageButton)findViewById(R.id.answer4_3);
        btn4 =(ImageButton)findViewById(R.id.answer4_4);

        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(quiz4.this, "정답입니다~!", Toast.LENGTH_SHORT).show();
                correct_count+=1;
                leveltest_correct+=1;
                finish();
                return;
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                type[3]++;
                Toast.makeText(quiz4.this, "땡 틀렸습니다...", Toast.LENGTH_SHORT).show();
