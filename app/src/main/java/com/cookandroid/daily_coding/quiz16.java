...
public class quiz16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1 =(ImageButton)findViewById(R.id.answer16_1);
        btn2 =(ImageButton)findViewById(R.id.answer16_2);
        btn3 =(ImageButton)findViewById(R.id.answer16_3);
        btn4 =(ImageButton)findViewById(R.id.answer16_4);

        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                type[3]++;
                Toast.makeText(quiz16.this, "땡 틀렸습니다...", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(getApplicationContext(),answer16.class);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(quiz16.this, "정답입니다~!", Toast.LENGTH_SHORT).show();
                correct_count+=1;
                leveltest_correct+=1;
                finish();
                return;
