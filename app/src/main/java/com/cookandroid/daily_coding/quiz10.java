...
public class quiz10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1 =(ImageButton)findViewById(R.id.answer10_1);
        btn2 =(ImageButton)findViewById(R.id.answer10_2);
        btn3 =(ImageButton)findViewById(R.id.answer10_3);
        btn4 =(ImageButton)findViewById(R.id.answer10_4);

        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                type[1]++;
                Toast.makeText(quiz10.this, "땡 틀렸습니다...", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(getApplicationContext(),answer10.class);
        ...
        btn4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(quiz10.this, "정답입니다~!", Toast.LENGTH_SHORT).show();
                correct_count+=1;
                leveltest_correct+=1;
                finish();
                return;
