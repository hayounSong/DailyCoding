...
public class quiz6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1 =(ImageButton)findViewById(R.id.answer6_1);
        btn2 =(ImageButton)findViewById(R.id.answer6_2);
        btn3 =(ImageButton)findViewById(R.id.answer6_3);
        btn4 =(ImageButton)findViewById(R.id.answer6_4);

        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                type[2]++;
                Toast.makeText(quiz6.this, "땡 틀렸습니다...", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(getApplicationContext(),answer6.class);
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(quiz6.this, "정답입니다~!", Toast.LENGTH_SHORT).show();
                correct_count+=1;
                leveltest_correct+=1;
                finish();
                return;
