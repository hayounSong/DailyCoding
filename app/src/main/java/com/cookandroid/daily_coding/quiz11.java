...
public class quiz11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quiz11);
        total_count+=1;

        btn1 =(ImageButton)findViewById(R.id.answer11_1);
        btn2 =(ImageButton)findViewById(R.id.answer11_2);
        btn3 =(ImageButton)findViewById(R.id.answer11_3);
        btn4 =(ImageButton)findViewById(R.id.answer11_4);

        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(quiz11.this, "정답입니다~!", Toast.LENGTH_SHORT).show();
                correct_count+=1;
                leveltest_correct+=1;
                finish();
                return;
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                type[0]++;
                Toast.makeText(quiz11.this, "땡 틀렸습니다...", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(getApplicationContext(),answer11.class);
