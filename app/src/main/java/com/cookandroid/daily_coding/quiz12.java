...
public class quiz12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quiz12);
        total_count+=1;

        btn1 =(ImageButton)findViewById(R.id.answer12_1);
        btn2 =(ImageButton)findViewById(R.id.answer12_2);
        btn3 =(ImageButton)findViewById(R.id.answer12_3);
        btn4 =(ImageButton)findViewById(R.id.answer12_4);

        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                type[4]++;
                Toast.makeText(quiz12.this, "땡 틀렸습니다...", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(getApplicationContext(),answer12.class);
        ...
        btn4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(quiz12.this, "정답입니다~!", Toast.LENGTH_SHORT).show();
                correct_count+=1;
                leveltest_correct+=1;
                finish();
                return;
